        ...
        <Image
          ...
          >
            ...
            <p className="mx-auto lg:w-11/12">
              We’ve organized over 500 successful events, delivering exceptional service and unforgettable experiences.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Successful Events</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: { opacity: 0, y: -20 },
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Awards & Recognitions</p>
            </motion.div>
          </div>
        </div>
      </section>
