...
import { BookOpen, Car, Video, Camera, Calendar, Users } from "lucide-react";
...
const AcademicConferencePage = () => {
  ...
  const ServiceCard = ({ title, description, icon }) => (
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
      <div className="flex items-center mb-4">
        <div className="mr-4 text-3xl text-indigo-600">{icon}</div>
  ...
  return (
    <ThemeProvider enableSystem={false} attribute="class" defaultTheme="light">
      <Lines />
      <Header />
      <div className="mt-14 from-indigo-50 to-slate-100 dark:bg-black">
        <div className="container mx-auto px-4 py-12 dark:bg-black">
          ...
          <div className="relative mb-12" style={{ height: "8cm" }}>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-14 text-white">
              ...
              <button
                ...
                className="bg-white text-indigo-600 px-8 py-3 rounded-full font-semibold hover:bg-indigo-50 transition-colors mt-4 md:mt-0 shadow-lg"
              >
                {showBookingForm ? "Close Booking" : "Plan Academic Conference"}
              </button>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <ServiceCard
                ...
                description="Complete abstract submission platform, peer review coordination, and research paper management systems."
              />
              <ServiceCard
                title="Presentation Management"
                icon={<Car className="text-indigo-600" />}
                description="Organization of keynote sessions, parallel tracks, poster presentations, and workshop facilitation."
              />
              <ServiceCard
                title="Conference Program"
                icon={<Calendar className="text-indigo-600" />}
                description="Detailed scheduling of sessions, breaks, networking events, and academic activities with digital program access."
              />
              <ServiceCard
                title="Virtual Solutions"
                icon={<Video className="text-indigo-600" />}
                description="Hybrid and virtual conference platforms, live streaming, and interactive online session management."
              />
              <ServiceCard
                title="Documentation"
                icon={<Camera className="text-indigo-600" />}
                description="Professional recording of presentations, proceedings compilation, and conference documentation services."
              />
              <ServiceCard
                title="Delegate Management"
                icon={<Users className="text-indigo-600" />}
                description="Registration handling, accommodation coordination, and comprehensive participant support services."
              />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-black rounded-2xl p-10 text-center shadow-lg">
            ...
            <blockquote className="text-xl italic dark:text-white text-gray-600 max-w-2xl mx-auto flex items-center justify-center">
              <svg className="w-10 h-10 text-indigo-500 mr-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              "We specialize in creating professional academic environments that facilitate meaningful scholarly exchange. Our expertise in academic conference management ensures smooth execution of both in-person and virtual scholarly events."
              <svg className="w-10 h-10 text-indigo-500 ml-4" fill="currentColor" viewBox="0 0 24 24">
...
export default AcademicConferencePage;